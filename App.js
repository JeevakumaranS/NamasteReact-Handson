...
const Title =()=> (
    <a href="/">
    <img className="logo" alt="logo" src="https://tse4.mm.bing.net/th/id/OIP.SdmxB-WQw_AoDU-hkfHGYgAAAA?r=0&w=335&h=326&rs=1&pid=ImgDetMain&o=7&rm=3"/>
    </a>
)
const styleObj = {
    backgroundColor:"red"
...
const burgerKing = {
    name: "Burger King",
    image: "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1600,h_640,c_fill/nojbxkhxcsbd68shlyct",
    cusines:["Burger","American"],
    rating:"4.2"
}

const RestaurantCard = ({name , cloudinaryImageId , cuisines , deliveryTime,uuid} ) => {
